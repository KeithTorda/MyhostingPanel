...
Route::group(['prefix' => '/account'], function () {
    Route::get('/', [Client\AccountController::class, 'index'])->name('api:client.account.view');
...
Route::group([
    ...
    Route::get('/renewal', [Client\Servers\RenewalController::class, 'index'])->middleware('throttle:60,1');
    Route::post('/renew', [Client\Servers\RenewalController::class, 'renew'])->middleware('throttle:6,1');
    ...
    Route::group(['prefix' => '/crossplay'], function () {
        Route::post('/sync', [Client\Servers\CrossplayController::class, 'sync']);
    });
    ...
    Route::post('/importer', [Client\Servers\ImporterController::class, 'import']);
    Route::get('/importer/status', [Client\Servers\ImporterController::class, 'status']);
    Route::get('/versions', [Client\Servers\ImporterController::class, 'getVersions']);
    
    Route::post('/versions/install', [Client\Servers\ImporterController::class, 'installVersion']);
    Route::post('/plugins/install', [Client\Servers\ImporterController::class, 'installPlugin']);
});
